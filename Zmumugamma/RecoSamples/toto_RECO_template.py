...
process.analysis = cms.EDAnalyzer("TotoAnalyzer",
	myConfig = cms.PSet(
		...
		RootFileName = cms.untracked.string('OUTPUTFILE'),

		# DATASET Infos  (will be written in runTree for bookeeping)
		xsection = cms.untracked.double(XSECTION),
		description = cms.untracked.string('DESCRIPTION'),
    ...
    signalGenerator = cms.untracked.string('SIGNALGENERATOR'),
