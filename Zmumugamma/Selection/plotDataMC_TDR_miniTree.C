...
/*
	...
	double XSectionTTbarJets_Tauola = 33.25;
	double XSectionWJets_7TeV = 11541.4;
	double XSectionZJets_7TeV = 911.84;
...
/*	double QCD_Mu_Pt30to50Max = Histo_QCD_Mu_Pt30to50->GetMaximum();
	...
	double QCD_Mu_Pt120to170Max = Histo_QCD_Mu_Pt120to170->GetMaximum();
...
/*	double ZmumuJet_Pt15to20Max = Histo_ZmumuJet_Pt15to20->GetMaximum();
	...
	double ZmumuJet_Pt30to50Max = Histo_ZmumuJet_Pt30to50->GetMaximum();
	YMax = max(YMax, ZmumuJet_Pt30to50Max);
	double ZmumuJet_Pt50to80Max = Histo_ZmumuJet_Pt50to80->GetMaximum();
	YMax = max(YMax, ZmumuJet_Pt50to80Max);
	double ZmumuJet_Pt80to120Max = Histo_ZmumuJet_Pt80to120->GetMaximum();
	YMax = max(YMax, ZmumuJet_Pt80to120Max);
	double ZmumuJet_Pt120to170Max = Histo_ZmumuJet_Pt120to170->GetMaximum();
	YMax = max(YMax, ZmumuJet_Pt120to170Max);
	double ZmumuJet_Pt170to230Max = Histo_ZmumuJet_Pt170to230->GetMaximum();
	YMax = max(YMax, ZmumuJet_Pt170to230Max);
	double ZmumuJet_Pt230to300Max = Histo_ZmumuJet_Pt230to300->GetMaximum();
...
/*	double ZmumuJet_Pt15to20Min = YMax;
	...
	double ZmumuJet_Pt80to120Min = YMax;
	double ZmumuJet_Pt120to170Min = YMax;
...
/*	for( int ibin=1 ; ibin<Histo_QCD_Mu_Pt30to50->GetNbinsX() ; ibin++ ){
	...
	YMin = min(YMin, QCD_Mu_Pt30to50Min);
	for( int ibin=1 ; ibin<Histo_QCD_Mu_Pt50to80->GetNbinsX() ; ibin++ ){
		if( ((Histo_QCD_Mu_Pt50to80->GetBinContent(ibin))!=0) && ((Histo_QCD_Mu_Pt50to80->GetBinContent(ibin))<QCD_Mu_Pt50to80Min) ){
			QCD_Mu_Pt50to80Min = Histo_QCD_Mu_Pt50to80->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, QCD_Mu_Pt50to80Min);
	...
	for( int ibin=1 ; ibin<Histo_QCD_Mu_Pt120to170->GetNbinsX() ; ibin++ ){
		if( ((Histo_QCD_Mu_Pt120to170->GetBinContent(ibin))!=0) && ((Histo_QCD_Mu_Pt120to170->GetBinContent(ibin))<QCD_Mu_Pt120to170Min) ){
			QCD_Mu_Pt120to170Min = Histo_QCD_Mu_Pt120to170->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, QCD_Mu_Pt120to170Min);
	for( int ibin=1 ; ibin<Histo_QCD_Mu_Pt170toInf->GetNbinsX() ; ibin++ ){
		if( ((Histo_QCD_Mu_Pt170toInf->GetBinContent(ibin))!=0) && ((Histo_QCD_Mu_Pt170toInf->GetBinContent(ibin))<QCD_Mu_Pt170toInfMin) ){
			QCD_Mu_Pt170toInfMin = Histo_QCD_Mu_Pt170toInf->GetBinContent(ibin);
		}
	}
...
/*	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt15to20->GetNbinsX() ; ibin++ ){
	...
	YMin = min(YMin, ZmumuJet_Pt15to20Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt20to30->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt20to30->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt20to30->GetBinContent(ibin))<ZmumuJet_Pt20to30Min) ){
			ZmumuJet_Pt20to30Min = Histo_ZmumuJet_Pt20to30->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt20to30Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt30to50->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt30to50->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt30to50->GetBinContent(ibin))<ZmumuJet_Pt30to50Min) ){
			ZmumuJet_Pt30to50Min = Histo_ZmumuJet_Pt30to50->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt30to50Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt50to80->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt50to80->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt50to80->GetBinContent(ibin))<ZmumuJet_Pt50to80Min) ){
			ZmumuJet_Pt50to80Min = Histo_ZmumuJet_Pt50to80->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt50to80Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt80to120->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt80to120->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt80to120->GetBinContent(ibin))<ZmumuJet_Pt80to120Min) ){
			ZmumuJet_Pt80to120Min = Histo_ZmumuJet_Pt80to120->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt80to120Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt120to170->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt120to170->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt120to170->GetBinContent(ibin))<ZmumuJet_Pt120to170Min) ){
			ZmumuJet_Pt120to170Min = Histo_ZmumuJet_Pt120to170->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt120to170Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt170to230->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt170to230->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt170to230->GetBinContent(ibin))<ZmumuJet_Pt170to230Min) ){
			ZmumuJet_Pt170to230Min = Histo_ZmumuJet_Pt170to230->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt170to230Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt230to300->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt230to300->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt230to300->GetBinContent(ibin))<ZmumuJet_Pt230to300Min) ){
			ZmumuJet_Pt230to300Min = Histo_ZmumuJet_Pt230to300->GetBinContent(ibin);
		}
	}
	YMin = min(YMin, ZmumuJet_Pt230to300Min);
	for( int ibin=1 ; ibin<Histo_ZmumuJet_Pt300toInf->GetNbinsX() ; ibin++ ){
		if( ((Histo_ZmumuJet_Pt300toInf->GetBinContent(ibin))!=0) && ((Histo_ZmumuJet_Pt300toInf->GetBinContent(ibin))<ZmumuJet_Pt300toInfMin) ){
			ZmumuJet_Pt300toInfMin = Histo_ZmumuJet_Pt300toInf->GetBinContent(ibin);
		}
	}
...
/*	Histo_QCD_Pt15->Add(Histo_QCD_Pt30);
  ...
  Histo_QCD_Mu_Pt20to30->SetFillColor(kGreen+3);
...
/*		DrawDataMCplot_NormEntries_Fast(Data_miniTree, QCD_Pt15_miniTree, QCD_Pt30_miniTree, QCD_Pt80_miniTree, QCD_Pt170_miniTree, QCD_Pt300_miniTree, QCD_Pt470_miniTree, PhotonJet_Pt15_miniTree, PhotonJet_Pt30_miniTree, PhotonJet_Pt80_miniTree, PhotonJet_Pt170_miniTree, PhotonJet_Pt300_miniTree, TTbarJets_Tauola_miniTree, WJets_7TeV_miniTree, ZJets_7TeV_miniTree, QCD_Mu_Pt20to30_miniTree, QCD_Mu_Pt30to50_miniTree, QCD_Mu_Pt50to80_miniTree, QCD_Mu_Pt80to120_miniTree, QCD_Mu_Pt120to170_miniTree, QCD_Mu_Pt170toInf_miniTree, InclusiveMu15_miniTree, ZmumuJet_Pt0to15_miniTree, ZmumuJet_Pt15to20_miniTree, ZmumuJet_Pt20to30_miniTree, ZmumuJet_Pt30to50_miniTree, ZmumuJet_Pt50to80_miniTree, ZmumuJet_Pt80to120_miniTree, ZmumuJet_Pt120to170_miniTree, ZmumuJet_Pt170to230_miniTree, ZmumuJet_Pt230to300_miniTree, ZmumuJet_Pt300toInf_miniTree, "MuonS_Eta", "(50,-3,3)", set_of_cuts[i], name[i], "#eta #mu_{subleading}", true, false, c1);
		...
		DrawDataMCplot_NormEntries_Fast(Data_miniTree, QCD_Pt15_miniTree, QCD_Pt30_miniTree, QCD_Pt80_miniTree, QCD_Pt170_miniTree, QCD_Pt300_miniTree, QCD_Pt470_miniTree, PhotonJet_Pt15_miniTree, PhotonJet_Pt30_miniTree, PhotonJet_Pt80_miniTree, PhotonJet_Pt170_miniTree, PhotonJet_Pt300_miniTree, TTbarJets_Tauola_miniTree, WJets_7TeV_miniTree, ZJets_7TeV_miniTree, QCD_Mu_Pt20to30_miniTree, QCD_Mu_Pt30to50_miniTree, QCD_Mu_Pt50to80_miniTree, QCD_Mu_Pt80to120_miniTree, QCD_Mu_Pt120to170_miniTree, QCD_Mu_Pt170toInf_miniTree, InclusiveMu15_miniTree, ZmumuJet_Pt0to15_miniTree, ZmumuJet_Pt15to20_miniTree, ZmumuJet_Pt20to30_miniTree, ZmumuJet_Pt30to50_miniTree, ZmumuJet_Pt50to80_miniTree, ZmumuJet_Pt80to120_miniTree, ZmumuJet_Pt120to170_miniTree, ZmumuJet_Pt170to230_miniTree, ZmumuJet_Pt230to300_miniTree, ZmumuJet_Pt300toInf_miniTree, "Mmumugamma", "(100,70,110)", set_of_cuts[i], name[i], "M_{#mu#mu#gamma} (GeV)", true, false, c1);
