...
cp ${SPSDIR}/Zmumugamma/Selection/Apply_v06.exe ${TMPDIR}/
...
echo "EXECUTE JOB"
cd ${TMPDIR}/
#./Apply_v06.exe ${1} ${2} ${3} ${4} ${5} ${6} 2> ${2}.err | tee ${2}.out
./Apply_v06.exe ${1} ${2} ${ijob} ${3} ${4} ${5} ${6} ${7} 2> ${2}_part${ijob}.err | tee ${2}_part${ijob}.out
