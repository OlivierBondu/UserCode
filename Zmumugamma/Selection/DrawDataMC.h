...
#include "/sps/cms/obondu/CMSSW_3_9_7_v2/src/UserCode/IpnTreeProducer/interface/TRootDummyEvent.h"
...
void DrawDataMCplot(TTree *Data_miniTree, TTree *FSR_DYToMuMu_miniTree, string var, string pic, string limits, string cut, string name, string Title, bool inlog, bool drawUnderOverFsubleading, TCanvas *c1, bool doFit = false);
