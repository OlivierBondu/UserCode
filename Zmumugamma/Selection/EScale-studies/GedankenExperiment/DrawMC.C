...
*/
  ...
  legend->AddEntry(Histo_FSR_DYToMuMu_powheg->GetName(), "ZmumuJet FSR", "f");
...
void DrawMCplot_TH1I(TTree *Data_miniTree, TTree *QCD_Pt15_miniTree, TTree *QCD_Pt30_miniTree, TTree *QCD_Pt80_miniTree, TTree *QCD_Pt170_miniTree, TTree *QCD_Pt300_miniTree, TTree *QCD_Pt470_miniTree, TTree *PhotonJet_Pt15_miniTree, TTree *PhotonJet_Pt30_miniTree, TTree *PhotonJet_Pt80_miniTree, TTree *PhotonJet_Pt170_miniTree, TTree *PhotonJet_Pt300_miniTree, TTree *TTbarJets_Tauola_miniTree, TTree *WJets_7TeV_miniTree, TTree *ZJets_7TeV_miniTree, TTree *QCD_Mu_Pt20to30_miniTree, TTree *QCD_Mu_Pt30to50_miniTree, TTree *QCD_Mu_Pt50to80_miniTree, TTree *QCD_Mu_Pt80to120_miniTree, TTree *QCD_Mu_Pt120to170_miniTree, TTree *QCD_Mu_Pt170toInf_miniTree, TTree *InclusiveMu15_miniTree, TTree *FSR_DYToMuMu_powheg_miniTree, TTree *FSR_ZmumuJet_Pt15to20_miniTree, TTree *FSR_ZmumuJet_Pt20to30_miniTree, TTree *FSR_ZmumuJet_Pt30to50_miniTree, TTree *FSR_ZmumuJet_Pt50to80_miniTree, TTree *FSR_ZmumuJet_Pt80to120_miniTree, TTree *FSR_ZmumuJet_Pt120to170_miniTree, TTree *FSR_ZmumuJet_Pt170to230_miniTree, TTree *FSR_ZmumuJet_Pt230to300_miniTree, TTree *FSR_ZmumuJet_Pt300toInf_miniTree, TTree *ISR_ZmumuJet_Pt0to15_miniTree, TTree *ISR_ZmumuJet_Pt15to20_miniTree, TTree *ISR_ZmumuJet_Pt20to30_miniTree, TTree *ISR_ZmumuJet_Pt30to50_miniTree, TTree *ISR_ZmumuJet_Pt50to80_miniTree, TTree *ISR_ZmumuJet_Pt80to120_miniTree, TTree *ISR_ZmumuJet_Pt120to170_miniTree, TTree *ISR_ZmumuJet_Pt170to230_miniTree, TTree *ISR_ZmumuJet_Pt230to300_miniTree, TTree *ISR_ZmumuJet_Pt300toInf_miniTree, string var, string pic, string limits, string cut, string name, string Title, bool inlog, bool drawUnderOverFsubleading, TCanvas *c1, bool doFit){
  ...
  // Get Histo_FSR_DYToMuMu_powheg from eventTree
  TH1I *Histo_FSR_DYToMuMu_powheg_temp = new TH1I();
  string variable_FSR_DYToMuMu_powheg = var + ">>Histo_FSR_DYToMuMu_powheg_temp" + limits;
  FSR_DYToMuMu_powheg_miniTree->Draw(variable_FSR_DYToMuMu_powheg.c_str(), cut.c_str());
  TH1I *Histo_FSR_DYToMuMu_powheg = (TH1I*)gDirectory->Get("Histo_FSR_DYToMuMu_powheg_temp");
  c1->Clear();
...
/*
  ...
  double XSectionFSR_DYToMuMu_powheg = 4.434e+03;
  ...
  double InitialNumberFSR_DYToMuMu_powheg = 235420;
  ...
  Histo_FSR_DYToMuMu_powheg->Scale((double)(  (double)((double)(XSectionFSR_DYToMuMu_powheg) / (double)(InitialNumberFSR_DYToMuMu_powheg)) * (double)integratedLuminosity));
  ...
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt15to20);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt20to30);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt30to50);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt50to80);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt80to120);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt120to170);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt170to230);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt230to300);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_FSR_ZmumuJet_Pt300toInf);
...
// *** stacked
//  Histo_FSR_DYToMuMu_powheg->Add(Histo_QCD_Pt15);
//  Histo_FSR_DYToMuMu_powheg->Add(Histo_QCD_Mu_Pt20to30);
  Histo_FSR_DYToMuMu_powheg->Add(Histo_InclusiveMu15);
// *** stacked
...
//  Histo_allMC->Add(Histo_FSR_DYToMuMu_powheg);
...
//  YMax = max(YMax, ZJets_7TeVMax);
  double FSR_DYToMuMu_powhegMax = Histo_FSR_DYToMuMu_powheg->GetMaximum();
  YMax = max(YMax, FSR_DYToMuMu_powhegMax);
/*
	double allMCMax = Histo_allMC->GetMaximum();
  YMax = max(YMax, allMCMax);
*/
...
//  cout << "YMin_log= " << YMin_log << "\t\tYMax_log= " << YMax_log << endl;
  ...
  string canvas_name = "MC_" + pic + "_" + name;
  std::ostringstream binWidthOSS;
...
//  legend->AddEntry(Histo_InclusiveMu15->GetName(), "InclusiveMu15", "f");
  ...
  Histo_FSR_DYToMuMu_powheg->Draw("same");
...
//  legend->AddEntry(Histo_ZJets_7TeV->GetName(), "ZJets madgraph", "f");
  ...
  // Print the canvas
  string PicName="gif/MC_" + pic + "_" + name + ".gif";
  c1->Print(PicName.c_str());
  PicName="eps/MC_" + pic + "_" + name + ".eps";
  c1->Print(PicName.c_str());
  string convert = "convert eps/MC_" + pic + "_" + name + ".eps" + " pdf/MC_" + pic + "_" + name + ".pdf";
  system(convert.c_str());
  if (inlog==true) {
    c1->cd(1);
    ...
    c1->Update();
    c1->Draw();
    string PicName_log="gif/MC_" + pic + "_" + name + "_log.gif";
    c1->Print(PicName_log.c_str());
    PicName="eps/MC_" + pic + "_" + name + "_log.eps";
    c1->Print(PicName.c_str());
    string convert = "convert eps/MC_" + pic + "_" + name + "_log.eps" + " pdf/MC_" + pic + "_" + name + "_log.pdf";
    system(convert.c_str());
    c1->SetLogy(0);
    c1->Update();
  }
...
void DrawMCplot_TH2F(TTree *Data_miniTree, TTree *QCD_Pt15_miniTree, TTree *QCD_Pt30_miniTree, TTree *QCD_Pt80_miniTree, TTree *QCD_Pt170_miniTree, TTree *QCD_Pt300_miniTree, TTree *QCD_Pt470_miniTree, TTree *PhotonJet_Pt15_miniTree, TTree *PhotonJet_Pt30_miniTree, TTree *PhotonJet_Pt80_miniTree, TTree *PhotonJet_Pt170_miniTree, TTree *PhotonJet_Pt300_miniTree, TTree *TTbarJets_Tauola_miniTree, TTree *WJets_7TeV_miniTree, TTree *ZJets_7TeV_miniTree, TTree *QCD_Mu_Pt20to30_miniTree, TTree *QCD_Mu_Pt30to50_miniTree, TTree *QCD_Mu_Pt50to80_miniTree, TTree *QCD_Mu_Pt80to120_miniTree, TTree *QCD_Mu_Pt120to170_miniTree, TTree *QCD_Mu_Pt170toInf_miniTree, TTree *InclusiveMu15_miniTree, TTree *FSR_DYToMuMu_powheg_miniTree, TTree *FSR_ZmumuJet_Pt15to20_miniTree, TTree *FSR_ZmumuJet_Pt20to30_miniTree, TTree *FSR_ZmumuJet_Pt30to50_miniTree, TTree *FSR_ZmumuJet_Pt50to80_miniTree, TTree *FSR_ZmumuJet_Pt80to120_miniTree, TTree *FSR_ZmumuJet_Pt120to170_miniTree, TTree *FSR_ZmumuJet_Pt170to230_miniTree, TTree *FSR_ZmumuJet_Pt230to300_miniTree, TTree *FSR_ZmumuJet_Pt300toInf_miniTree, TTree *ISR_ZmumuJet_Pt0to15_miniTree, TTree *ISR_ZmumuJet_Pt15to20_miniTree, TTree *ISR_ZmumuJet_Pt20to30_miniTree, TTree *ISR_ZmumuJet_Pt30to50_miniTree, TTree *ISR_ZmumuJet_Pt50to80_miniTree, TTree *ISR_ZmumuJet_Pt80to120_miniTree, TTree *ISR_ZmumuJet_Pt120to170_miniTree, TTree *ISR_ZmumuJet_Pt170to230_miniTree, TTree *ISR_ZmumuJet_Pt230to300_miniTree, TTree *ISR_ZmumuJet_Pt300toInf_miniTree, string var1, string var2, string limits, string cut, string name, string Title_var1, string Title_var2, string pic, bool inlog_var1, bool inlog_var2, TCanvas *c1, bool doFit){
  ...
  // Get Histo_FSR_DYToMuMu_powheg from eventTree
  TH2F *Histo_FSR_DYToMuMu_powheg_temp = new TH2F();
  string variable_FSR_DYToMuMu_powheg = var2 + ":" + var1 + ">>Histo_FSR_DYToMuMu_powheg_temp" + limits;
  FSR_DYToMuMu_powheg_miniTree->Draw(variable_FSR_DYToMuMu_powheg.c_str(), cut.c_str());
  TH2F *Histo_FSR_DYToMuMu_powheg = (TH2F*)gDirectory->Get("Histo_FSR_DYToMuMu_powheg_temp");
  c1->Clear();
...
//  legend->AddEntry(Histo_InclusiveMu15->GetName(), "InclusiveMu15", "f");
  ...
  Histo_FSR_DYToMuMu_powheg->SetLineColor(kBlack);
  Histo_FSR_DYToMuMu_powheg->SetFillColor(kRed);
	Histo_FSR_DYToMuMu_powheg->SetMarkerColor(kRed);
  Histo_FSR_DYToMuMu_powheg->SetFillStyle(3001);
...
//  Histo_QCD_Mu_Pt20to30->Draw("SCATsame");
	Histo_InclusiveMu15->Draw("SCATsame");
  Histo_FSR_DYToMuMu_powheg->Draw("SCATsame");
...
//	Histo_FSR_DYToMuMu_powheg->Fit("f", fitOpts.c_str());
...
/*
  if (inlog==true) {
    ...
    c1->Update();
    c1->Draw();
    string PicName_log="Plots_TEST/gif/MC_" + pic + "_" + name + "_log.gif";
    c1->Print(PicName_log.c_str());
    PicName="Plots_TEST/eps/MC_" + pic + "_" + name + "_log.eps";
    c1->Print(PicName.c_str());
    string convert = "convert Plots_TEST/eps/MC_" + pic + "_" + name + "_log.eps" + " Plots_TEST/pdf/MC_" + pic + "_" + name + "_log.pdf";
    system(convert.c_str());
    c1->SetLogy(0);
    c1->Update();
  }
