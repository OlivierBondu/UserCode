...
cat dump3 | awk '{print "<"$3"><GedankenNumber>"$1"</GedankenNumber><NumberEvents>"$4"</NumberEvents><Chi2Ndf>"$5"</Chi2Ndf><Constant>"$6"</Constant><deltaConstant>"$7"</deltaConstant><"$2">"$8"</"$2"><delta"$2">"$9"</delta"$2"><delta"$2"_"$2">"$10"</delta"$2"_"$2"><Sigma>"$11"</Sigma><deltaSigma>"$12"</deltaSigma><deltaSigma_Sigma>"$13"</deltaSigma_Sigma></"$3">"}' >> full_MC.xml
