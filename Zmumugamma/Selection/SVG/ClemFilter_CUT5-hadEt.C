...
// ********************************************************************
	...
	unsigned int nSelected=0, NbEventsAfterCSA07ID = 0, NbEventsAfterZJETVETO = 0, NbEventsAfterC1a = 0, NbEventsAfterC1b = 0, NbEventsAfterC1c = 0, NbEventsAfterC1d = 0, NbEventsAfterC1e = 0, NbEventsAfterC2a = 0, NbEventsAfterC2b = 0, NbEventsAfterC2c = 0, NbEventsAfterC3 = 0, NbEventsAfterC4 = 0, NbEventsAfterC5 = 0, NbEventsAfterC6 = 0, NbEventsAfterC7 = 0, NbEventsAfterC8 = 0, NbEventsAfterC9 = 0, NbEventsAfterC10 = 0, NbEventsAfterC11 = 0;
                          ...
                          if(farMuon->isoR03_emEt() <= 1.0) {
                            ...
                            if(farMuon->Pt() >= 30.0) {
                              NbEventsAfterC9++;
				                      ...
				                      // *** cut 10 ***
        				              // ********************************************************************
				                      if( nearMuon->isoR03_hadEt() < 1.0 ){// *** cut 10 ***
        				                NbEventsAfterC10++;

																// ********************************************************************
																// *** cut 11 ***
																// ********************************************************************
																if( deltaRmin<=0.8 ){// *** cut 11 ***
																	NbEventsAfterC11++;
																...
																else { cerr << "\tCUT: event " << ievt  << " CUT at level XI for gamma/mu correlation" << endl; }
															}// end of cut 10
															else { cerr << "\tCUT: event " << ievt  << " CUT at level X for large hadEt" << endl; }

                            }//end of cut 9
                            else { cerr << "\tCUT: event " << ievt  << " CUT at level IX for muon far Pt " << endl; }

                          }//end of cut 8
                          else { cerr << "\tCUT: event " << ievt  << " CUT at level VIII for large emEt " << endl; }
...
// ********************************************************************
  ...
  cout<<"Number of events after cut 11 :\t"<<NbEventsAfterC11<<"\t( "<<(double)NbEventsAfterC11/(double)NbEvents*100.0<<" % )"<<endl;
